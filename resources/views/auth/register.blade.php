        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST"
                        action="{{ isset($perfil) ? route('perfil.update', $perfil->pk_perfil_id) : route('register') }}"
                        class="overflow-y-auto px-1 " enctype="multipart/form-data">
                        @csrf
                        @if(isset($perfil))
                            @method('PUT')
                        @endif
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                :value="old('str_nombre', $perfil->str_nombre ?? '')" required autofocus
                                autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            w-full" type="text" name="curp" :value="old('str_curp', $perfil->str_curp ?? '')" required
                                autofocus autocomplete="curp" />
