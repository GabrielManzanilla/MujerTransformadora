                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('register') }}" class="overflow-y-auto px-1 "
                        ...
                        <div class="mt-4">
                            ...
                            w-full" type="text" name="curp" :value="old('curp')" required autofocus
                                autocomplete="curp" />
                        ...
                        <div class="flex">
                            <div class="mt-4 w-1/2">
                                ...
                                <x-text-input id="municipio_nacimiento" class="block mt-1 w-full" type="text"
                                    name="municipio_nacimiento" :value="old('municipio_nacimiento')" required autofocus
                            ...
                            <div class="mt-4 w-1/2 ms-4">
                                ...
                                <x-text-input id="estado_nacimiento" class="block mt-1 w-full" type="text"
                                    name="estado_nacimiento" :value="old('estado_nacimiento')" required autofocus
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex gap-1">
                                ...
                                {{ old('es_mayahablante') ? 'checked' : '' }} class="rounded border-gray-300 text-secondary shadow-sm focus:border-secondary focus:ring focus:ring-secondary focus:ring-opacity-50">
