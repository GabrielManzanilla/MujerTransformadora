        ...
        <div class="flex items-center justify-between h-16 ">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-secondary hover:text-secondary hover:bg-white focus:outline-white transition ease-in-out duration-150">
                                <div>
                                    {{ Auth::user()->perfil->str_nombre . ' ' . Auth::user()->perfil->str_apellido_paterno}}
                                </div>
                                <div class="ms-1">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-secondary focus:outline-none focus:bg-secondary focus:text-white transition duration-150 ease-in-out">
